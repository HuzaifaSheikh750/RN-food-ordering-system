  ...
  return (
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: COLORS.white }}>
      ...
      <View style={styles.imageConatainer}>
        <Image source={restaurant.image_url} style={{ resizeMode: 'contain', flex: 1 }} />
      </View>
      <View style={styles.detailContainer}>
        ...
        <View style={{ marginLeft: 20, marginTop: 20, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <View style={styles.priceTag}>
            <Text style={{ marginLeft: 15, color: COLORS.white, fontWeight: 'bold', fontSize: 16 }}>{restaurant.price}</Text>
          </View>
        </View>
